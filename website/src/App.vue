...
const goToGithubPage = (hash: string) => {
  window.open(
    `https://github.com/acTechWorld/vue-onboarding-tour/tree/master/library?tab=readme-ov-file#${hash}`,
  )
}
const goToStoryBook = () => {
  window.open(
...
<template>
  <main class="bg-black relative min-h-screen">
    ...
    <VueOnboardingTour v-bind="configOnboardingTour" :star ref="onboardingTourPoppin" aria-label="Interactive onboarding tour for Vue application"/>
